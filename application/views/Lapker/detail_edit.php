									...
									<tbody>
										<?php foreach ($all_detail_lapker as $detail_lapker): ?>
											<tr>
												...
												<td align="center">
												<a href="<?= base_url('lapker/ubah/'.$detail_lapker->id.'/' . $detail_lapker->idrincian) ?>" class="btn btn-warning text-dark btn-sm"><i class="fa fa-edit"></i></a>
												<a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('lapker/detail_hapus/'.$detail_lapker->id.'/' . $detail_lapker->idrincian) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
											</td>
											</tr>
										<?php endforeach ?>
									</tbody>
