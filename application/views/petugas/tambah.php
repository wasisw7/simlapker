								...
								<form action="<?= base_url('petugas/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode" placeholder="Masukkan Kode Petugas" autocomplete="off"  class="form-control" required value="PG - <?= mt_rand(10, 99) ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
